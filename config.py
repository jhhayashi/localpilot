...
models = {
    ...
    # llama.cpp only supports running Q4_0 models on metal
    ...
    # llama.cpp only supports running Q4_0 models on metal
    'CodeLlama-Python-13B_metal': {
        'url': 'https://huggingface.co/TheBloke/CodeLlama-13B-Python-GGUF/resolve/main/codellama-13b-python.Q4_0.gguf',
        'type': 'local',
